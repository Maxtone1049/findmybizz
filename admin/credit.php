...
<html lang="en">
  <head>
    ...
    <title> Business ||  FindmyBizz</title>
...
include_once('includes/sidebar.php');
 ...
 ?>
    ...
    <div class="am-pagetitle">
      <h5 class="am-title">All Business</h5>
    ...
    <div class="am-mainpanel">
      <div class="am-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">All Business</h6>
            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  ...
                  <th class="wd-20p">Business Name</th>
                  
                  <th class="wd-10p">Posy By</th>
...
{               ?>
                <tr>
                  ...
                  <td><?php  echo htmlentities($row->post_by);?></td>
