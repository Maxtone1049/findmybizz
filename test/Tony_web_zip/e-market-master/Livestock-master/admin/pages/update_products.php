                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="gtotal" id="gtotal">
                            </div>
                            <div class="col-md-6">
                                <label for="tax">Tax</label>
                                <input type="text" placeholder="tax" value="2" class="form-control" name="discount" id="tax">
                            </div>
                        </div>
...
<script>
    ...
    $('#frm_update_product').on('submit', function(e){
        ...
        form_data.append('grand_total',  $('#gtotal').val());
        ...
        $.ajax({
            ...
            success: function(response){
                if(response.status == 'success'){
                    ...
                    window.location.href = 'http://localhost/livestock-master/admin/index.php'
                }else{
                    alert(response.message)
                }
            }
