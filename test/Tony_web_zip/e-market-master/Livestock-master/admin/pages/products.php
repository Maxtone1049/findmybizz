                    ...
                    <form id="frm_add_product" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                <label for="quant">Quantity</small></label>
                                <input type="text" placeholder="Quantity" class="form-control" name="quantity" id="quantity">
                            </div>
                           <div class="col-md-6">
                                <label for="total">Total</small></label>
                                <input type="text" placeholder="Total" class="form-control" name="total" disabled="" id="tot">
                            </div>
                            <div class="col-md-6">
                                <label for="grandtotal">Grand Total</label>
                                <input type="text" placeholder="Grand Total" class="form-control" name="gtotal" disabled="" id="grandt">
                            </div>
                            <div class="col-md-6">
                                <label for="tax">Tax</label>
                                <input type="text" value="2" class="form-control" disabled="" name="tax" disabled="" id="tax">
                            </div>
                        </div>
                        <input type="button" value="Calculate" onclick="calculatepro()" class="btn btn-primary btn-sm">
                        <div class="form-group">
...
<script type="text/javascript">
    ...
    var taxt = result * (tax/100);
    var gtotal= taxt + result;
    document.getElementById("grandt").value= gtotal;
...
<script>
  function fetchProduct(){
    ...
    $('#frm_add_product').on('submit', function(e){
        ...
        form_data.append('total',  $('#tot').val());
        form_data.append('grand_total',  $('#grandt').val());
