                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="d-inline-block">
                                    <a class="btn btn-raised btn-info mr-5" href="create/post">Create Service</a>
                                    <a class="btn btn-raised btn-success mr-5" href="edit">Edit Profile</a>
...
{  $cnt=$cnt+1;}
?>
                                            <h3 class="text-primary"><?php echo htmlentities($totalnewapp);?> Service List</h3>
                                            <hr>
                                            <div>
                                                <div>
                                                    <a href="../post?viewid=<?php echo $row->ID;?>">
                                                        <div>
                                                            <p class="lead"><?php echo $row->business_name?></p>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
